...
namespace RM.QuickLogOn.OAuth.RU.Handlers
{
    ...
    public class MailRuSettingsPartHandler : ContentHandler
    {
        public Localizer T { get; set; }

        public MailRuSettingsPartHandler(IRepository<MailRuSettingsPartRecord> repository)
        {
            Filters.Add(new ActivatingFilter<MailRuSettingsPart>("Site"));
