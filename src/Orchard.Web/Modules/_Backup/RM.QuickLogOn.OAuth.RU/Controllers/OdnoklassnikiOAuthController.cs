...
namespace RM.QuickLogOn.OAuth.RU.Controllers
{
    ...
    public class OdnoklassnikiOAuthController : Controller
    {
        private readonly IOrchardServices _services;
        private readonly IOdnoklassnikiOAuthService _oauthService;

        public Localizer T { get; set; }

        public OdnoklassnikiOAuthController(IOrchardServices services, IOdnoklassnikiOAuthService oauthService)
        {
